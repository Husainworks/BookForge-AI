            ...
            <div className="relative flex-1 flex flex-col max-w-xs w-full bg-white">
              <div className="absolute top-0 right-0 -mr-12 pt-2">
                ...
                >
                  ...
                  <X className="h-5 w-6 text-white" />
                </button>
              </div>
        ...
        <main className="flex-1 h-full flex flex-col">
          <header className="sticky top-0 z-10 bg-white/80 backdrop-blur-sm border-b border-slate-200 p-3 flex justify-between items-center">
            <div className="flex  items-center gap-2">
              <button
                className="md:hidden p-2 transition-colors duration-200 text-slate-500 hover:text-slate-800"
              ...
              <div className="hidden sm:flex space-x-1 bg-slate-100 p-1 rounded-lg">
                <button
                  ...
                  className={`flex items-center cursor-pointer justify-center flex-1 py-2 px-4 text-sm font-medium rounded-md transition-colors duration-200 ${
                    activeTab === "editor"
                ...
                <button
                  ...
                  className={`flex items-center cursor-pointer justify-center flex-1 py-2 px-4 text-sm font-medium rounded-md transition-colors duration-200 whitespace-nowrap ${
                    activeTab === "details"
                      ? "bg-white text-slate-800 shadow-sm"
                      : "text-slate-500 hover:text-slate-700"
                  }`}
