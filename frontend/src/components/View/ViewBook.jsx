  ...
  return (
    <>
      <div className="flex bg-white text-gray-900">
        ...
        <main className="flex flex-1 h-[calc(100svh-64px)] flex-col overflow-hidden">
          <header className="flex items-center justify-between p-4 border-b border-gray-100">
            <div className="flex items-center gap-4">
              <button
                onClick={() => setSidebarOpen(true)}
                className="lg:hidden cursor-pointer p-1 hover:bg-gray-100 rounded-lg transition-colors"
              >
            ...
            <div className="flex items-center gap-2">
              <div className="flex items-center gap-2 mr-4">
                <button
                  ...
                  className="p-2 hover:bg-gray-100 rounded-lg transition-colors text-sm cursor-pointer font-bold"
                >
                  A-
                </button>
                ...
                <button
                  className="p-2 hover:bg-gray-100 rounded-lg transition-colors text-lg cursor-pointer font-bold"
