...
export const Navbar = () => {
  ...
  return (
    <>
      <header className="h-(--header-height) sticky top-0 z-50 bg-white w-vw">
            ...
            <div className="hidden lg:flex items-center space-x-3">
              {isAuthenticated ? (
                ...
                <>
                  ...
                  <a
                    href="/signup"
                    className="px-4 py-2 text-sm font-medium text-white bg-linear-to-r from-violet-400 to-purple-500 rounded-lg hover:from-violet-700 hover:to-purple-700 shadow-lg shadow-violet-500/30 hover:shadow-violet-500/50 transition-all duration-200 hover:scale-105"
                  >
                    Get Started
                  </a>
                </>
        ...
        {isOpen && (
          <div className="relative z-10 lg:hidden bg-white border-t border-gray-100 animate-in slide-in-from-top duration-200">
