          ...
          <div className="py-16 grid grid-cols-1 md:grid-cols-12 gap-12">
            <div className="md:col-span-5 space-y-6">
              <a href="/" className="flex items-center space-x-2.5 group">
                <div className="w-10 h-10 bg-linear-to-br from-violet-500 to-purple-600 rounded-xl flex items-center justify-center shadow-lg shadow-violet-500/30 group-hover:shadown-violet-500/50 transition-all duration-300 group-hover:scale-105">
          ...
          <div className="border-t border-white/10 py-8">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              ...
              <p className="text-gray-500 text-sm">
                Made with <span className="text-violet-400">❤︎</span> for
                creators
              </p>
            </div>
          </div>
