    ...
    <>
      ...
      >
        <div className="relative overflow-hidden bg-linear-to-br from-gray-50 to-gray-100">
          ...
          <div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex gap-4">
            <button
              onClick={(e) => {
                e.stopPropagation();
        ...
        <div className="absolute bottom-0 left-0 right-0 h-1 bg-linear-to-r from-orange-500 via-amber-500 to-rose-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
      </div>
    </>
  );
};
